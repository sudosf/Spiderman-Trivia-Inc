...
document.addEventListener('click', (event) => {
  ...
  if (event.target.tagName.toLowerCase() === 'img' ||event.target.tagName.toLowerCase() === 'p' ||event.target.tagName.toLowerCase() === 'a') {
      const parentElement = event.target.parentElement;
      
    if ((parentElement.tagName.toLowerCase()==='a' && parentElement.href.includes('leaderboard')) || (event.target.tagName.toLowerCase()==='a' && event.target.href.includes('leaderboard'))) {
      console.log("clicked")
